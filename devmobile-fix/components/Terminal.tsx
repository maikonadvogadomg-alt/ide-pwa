    ...
    >
      ...
      <View style={[styles.tabBar, { backgroundColor: colors.card, borderBottomColor: colors.border }]}>
        ...
        <TouchableOpacity
          ...
          style={[styles.addTab, showXTerm
            ? { backgroundColor: "#7c3aed22", borderColor: "#7c3aed66", borderWidth: 1 }
            : apiBase
            ? { backgroundColor: "#22c55e15", borderColor: "#22c55e55", borderWidth: 1 }
            : {}
          ]}
        >
          <Feather name="terminal" size={14} color={showXTerm ? "#a78bfa" : apiBase ? "#4ade80" : colors.mutedForeground} />
        </TouchableOpacity>
      ...
      {/* Banner: Terminal Linux disponível — aparece quando servidor está online */}
      {!showXTerm && apiBase && (
        <TouchableOpacity
          onPress={() => { setShowXTerm(true); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium); }}
          activeOpacity={0.8}
          style={{
            flexDirection: "row", alignItems: "center", gap: 10,
            backgroundColor: "#052e16", borderBottomWidth: 1, borderBottomColor: "#22c55e55",
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            <Text style={{ color: "#4ade80", fontWeight: "800", fontSize: 13 }}>
              🐧 Terminal Linux Real — bash, node, python, git, npm
            </Text>
            <Text style={{ color: "#86efac", fontSize: 10, marginTop: 1 }}>
              Toque aqui para abrir o terminal completo com xterm.js
            </Text>
          </View>
          <Feather name="terminal" size={18} color="#4ade80" />
        </TouchableOpacity>
      )}
