...
type SharedProps = {
  H2: (p: { children: string }) => React.ReactElement;
  H3: (p: { children: string }) => React.ReactElement;
  P: (p: { children: string }) => React.ReactElement;
  Li: (p: { children: string }) => React.ReactElement;
  Step: (p: { n: number; children: string }) => React.ReactElement;
  Alert: (p: { color: "green" | "blue" | "yellow" | "red"; children: string }) => React.ReactElement;
  Code: (p: { children: string; copyKey?: string }) => React.ReactElement;
  copied: string;
